    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <div className="flex items-center gap-3">
        <AnimatePresence>
          {hoveredTg && (
            <motion.div
              ...
              className="bg-[#111] border border-white/10 text-white text-sm font-medium px-4 py-2.5 rounded-xl shadow-xl whitespace-nowrap"
            >
              ✈️ Únete a nuestro Telegram
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <motion.a
          ...
          className="flex items-center justify-center w-12 h-12 rounded-full bg-[#229ED9] shadow-[0_4px_20px_rgba(34,158,217,0.4)] hover:bg-[#1a8ec4] transition-colors duration-200"
        >
          <IconTelegram />
        </motion.a>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          <span
            aria-hidden
            className="absolute inset-0 rounded-full bg-[#25D366] animate-ping-slow opacity-35"
          />
          <motion.a
            href={WA_URL}
            target="_blank"
            ...
            className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-[0_4px_24px_rgba(37,211,102,0.45)] hover:bg-[#20c45e] transition-colors duration-200"
          >
            <IconWhatsApp />
          </motion.a>
        </div>
